...
class CODSTATS(commands.Cog):
    ...
    async def codstats(self, ctx, platform, username):
        ...
        async with self._session.get(
                f"https://my.callofduty.com/api/papiclient/stats/cod/v1/title/mw/platform/{platform}/gamer/{username}/profile/type/mp"
        ) as request:
        ...
        try:
            ...
            await ctx.send("I done fucked up :worried:")