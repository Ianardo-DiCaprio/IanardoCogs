...
class BasicSetup(BASECOG):
    ...
    async def basic_setup(self, ctx):
        ...
        try:
            ...
            if cog:
                if await self._get_response(ctx, question1, predicate) == "yes" or "Yes":
                    ...
                    await asyncio.sleep(1)
                    autoban = await self._get_response(ctx, question2, predicate) == "yes" or "Yes"
                    if autoban == "yes":
                        await ctx.invoke(ctx.bot.get_command("antimentionspam autobantoggle"))
                        await asyncio.sleep(1)
                    mentions = await self._get_response(ctx, question3, predicate) == "yes" or "Yes"
                    if mentions == "yes":
        ...
        try:
            ...
            if cog:
                if await self._get_response(ctx, question4, predicate) == "yes" or "Yes":
        ...
        try:
            ...
            if cog:
                if await self._get_response(ctx, question5, predicate) == "yes" or "Yes":
        ...
        try:
            ...
            if cog:
                if await self._get_response(ctx, question6, predicate) == "yes" or "Yes":
        ...
        try:
            ...
            if cog:
                if await self._get_response(ctx, question7, predicate) == "yes" or "Yes":
        ...
        try:
            ...
            if cog:
                if await self._get_response(ctx, question8, predicate) == "yes" or "Yes":
                    name = await self._get_response(
        ...
        try:
            ...
            if cog:
                if await self._get_response(ctx, question9, predicate) == "yes" or "Yes":
        ...
        try:
            ...
            if cog:
                if await self._get_response(ctx, question10, predicate) == "yes" or "Yes":
        ...
        try:
            ...
            if cog:
                if await self._get_response(ctx, question11, predicate) == "yes" or "Yes":
        ...
        try:
            ...
            if cog:
                if await self._get_response(ctx, question12, predicate) == "yes" or "Yes":
        ...
        try:
            ...
            if cog:
                if await self._get_response(ctx, question13, predicate) == "yes" or "Yes":
        ...
        try:
            ...
            if cog:
                if await self._get_response(ctx, question14, predicate) == "yes" or "Yes":
                    await ctx.send(
        ...
        try:
            ...
            if cog:
                if await self._get_response(ctx, question17, predicate) == "yes" or "Yes":
                    await asyncio.sleep(1)
                    channelmessage = await self._get_response(
        ...
        try:
            ...
            if cog:
                if await self._get_response(ctx, question18, predicate) == "yes" or "Yes":
                    await asyncio.sleep(1)
                    channelmessage = await self._get_response(
        ...
        try:
            ...
            if cog:
                if await self._get_response(ctx, question19, predicate) == "yes" or "Yes":
                    await asyncio.sleep(1)
                    name = await self._get_response(
        ...
        try:
            ...
            if cog:
                if await self._get_response(ctx, question20, predicate) == "yes" or "Yes":
        ...
        try:
            ...
            if cog:
                if await self._get_response(ctx, question21, predicate) == "yes" or "Yes":
        ...
        try:
            ...
            if cog:
                if await self._get_response(ctx, question22, predicate) == "yes" or "Yes":
                    await asyncio.sleep(1)
                    rolemessage = await self._get_response(
        ...
        try:
            ...
            if cog:
                if await self._get_response(ctx, question23, predicate) == "yes" or "Yes":
                    await ctx.send(
